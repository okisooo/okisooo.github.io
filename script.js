...
(function () {
  var on = addEventListener,
    ...
    loadElements = function (parent) {
      ...
      switch (x) {
        case "FORM":
          e = e.querySelector(".fieldinput, .field select, .field textarea");
          if (e) e.focus();
          break;
        default:
          break;
  ...
  var thisUrl = function () {
    return;
    window.location.href.replace(window.location.search, "").replace(/#$/, "");
  };
  ...
  var onvisible = {
    ...
    add: function (selector, settings) {
      ...
      $$(selector).forEach(function (e) {
        var children =
            stagger !== false
              ? e.querySelectorAll(":scope > li, :scopeul > li")
              : null,
